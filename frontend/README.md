...
Also, you can assume you are running the script on the same machine as the Caspar CG Server (localhost).
...
- If you are new to CasparCG, getting your head around it might take some time: don't worry, we've all been there. Let us know if you need extra time.
